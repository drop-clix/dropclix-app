...
function FollowerGrowthChart({ data }: { data: MonthlyPoint[] }) {
  if (!data.length) return <p style={{ fontSize: 11, color: '#252525', textAlign: 'center', paddingTop: 60 }}>No monthly data</p>
  return (
...
function PillarERChart({ data }: { data: PillarPoint[] }) {
  if (!data.length) return <p style={{ fontSize: 11, color: '#252525', textAlign: 'center', paddingTop: 60 }}>No pillar data</p>
